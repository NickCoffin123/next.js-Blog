        ...
        <section className="card">
            ...
            <div style={{ marginTop: '2rem', padding: '1rem', background: '#f0f09ff', borderRadius: '8px', fondSize: '0.9rem'}}>
                ...
                <ul style={{ margin:'0.5rem 0', paddingLeft: '1.2rem'}}>
                    <li>You can edit or delete <strong>any</strong> post from the Blog Page</li>
                    <li>Authors can edit/delete <strong>only</strong> their own posts</li>
